"""
Django settings for mashupcommrz2 project.
...
SECRET_KEY = 'ogf1ek&i!1n6xyf4z%c8_kj(^kx-te1#dco^rf_^3!z206(^uw'
...
ROOT_URLCONF = 'mashupcommrz2.urls'
...
WSGI_APPLICATION = 'mashupcommrz2.wsgi.application'
